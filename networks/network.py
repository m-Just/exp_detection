...
class Network(object):
    ...
    def anchor_target_layer(self, input, _feat_stride, anchor_scales, name):
        ...
        with tf.variable_scope(name) as scope:
            ...
            rpn_labels, rpn_bbox_targets, rpn_bbox_inside_weights, rpn_bbox_outside_weights = \
                tf.py_func(anchor_target_layer_py, input[:3] + [_feat_stride, anchor_scales], [tf.float32] * 4)
    ...
    @layer
    def fc_deeplab(self, input, num_out, name, relu=True):
        with tf.variable_scope(name) as scope:
    ...
    @layer
    def softmax_deeplab(self, input, name):
    ...
    @layer
    def softmax_rcnn(self, input, name):
    ...
    @layer
    def dropout_deeplab(self, input, keep_prob, name):
